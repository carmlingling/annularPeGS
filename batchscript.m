...
%%file parameters
fileParams.topDir = '/eno/cllee3/DATA/241001/run1/'; % where the images are stored
...
pdParams.cen = [112+5304/2, 112+5304/2]; %measure the center of annulus in images taken by the camera
pdParams.rad = [2810/2, 5304/2];
