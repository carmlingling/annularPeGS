% update Lori S McCabe 08/2024 for PEGS 2.0 wrapper compatibility original version Carmen Lee modular and converted as basis for PEGS 2.0
...
cdParams.imadjust_limits = [0.1, 0.5];
cdParams.fineimadjust_limits = [8/255, 40/255];%[13/255, 39/255]
cdParams.sigma = pdParams.sigma; %for blurring large scale features
cdParams.polarizerstrip = [[2950, 2900,3560,	3593];[220,220,6099,6100]]%[[2940,2990,3645,3600];[220,220,6099,6100]];
...
if ~isfield(params,'metersperpixel') 
    params.metersperpixel = 0.001/44;
end
...
if ~isfield(params,'fineimadjust_limits') %adjust contrast in green channel for fine contact detection
    params.imadjust_limits = [8/255, 40/255];
end
